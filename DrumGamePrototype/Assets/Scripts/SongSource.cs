...
[System.Serializable]
public class ShooterChangeMap
{
	public int velocity;
	public int[] showShooters;
	public int[] hideShooters;
}
...
public class SongInfo
{
	...
	public float timeFromShooterToCenter;
...
public class SongsSource : MonoBehaviour {
	public static Song song;
	

	public static Song getSong(string fileName) {
		TextAsset file = Resources.Load("MidiData/"+fileName) as TextAsset;
